...
>
> Última atualização: **2026-06-29** · Versão atual: **v0.19.0** ·
> **Bloco 4 — Obrigações legais federais: iniciado (~12%)** — Onda **4.1**
> (eSocial fundação: geração de XML S-1000/S-1005 + validação XSD oficial
> S-1.3). **Bloco 3 — Folhas especiais: concluído (100%)**. Blocos 0 e 1
...
> — bloco fechado. **510 testes backend verde** + 10 frontend.
...
| 4 | Obrigações legais federais (eSocial, SEFIP, RAIS, DIRF, MANAD) | 🟡 Em andamento — ~12% (Onda 4.1: eSocial fundação — XML S-1000/S-1005 + XSD) |
