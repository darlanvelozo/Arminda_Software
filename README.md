...
- **Bloco corrente:** Bloco 4 — Obrigações legais federais **em andamento** (eSocial S-1000/S-1005/S-1010, geração de XML + validação XSD oficial S-1.3). Bloco 3 concluído. Bloco 2 a 85% (2.7 desbloqueada — base real do SIP disponível)
- **Testes:** 512 backend (pytest) + 10 frontend (vitest) verdes
